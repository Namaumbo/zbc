    ...
    <footer className="bg-footer_bg_color">
      <div className="flex flex-col md:flex-row justify-center items-center p-4">
        ...
        <div className="mb-4 md:mb-0 md:mr-10 md:ml-10 p-5 ">
          <ul className="flex flex-row md:flex-row space-y-4 md:space-y-0 text-white">
            <li className="md:mr-20 text-center">
              <a href="/" className="font-heading_secondary text-lg md:text-xl">
                Home
              </a>
            </li>
            <li className="md:mr-20 text-center">
              <a
                href="/services"
                className="font-heading_secondary text-lg md:text-xl"
              >
                Services
              </a>
            </li>
        ...
        <div className="flex justify-center md:mr-10 md:ml-10 p-5 gap-4 border border-white w-[80%]">
          <div>
            <p className="font-heading_secondary text-white font-semibold text-xl">
              For More information
            </p>
            <p className="text-white">Zomba Baptist Church </p>
            <p className="text-white">Post Office Box 000</p>
            <p className="text-white">Zomba, Malawi</p>
          </div>
          <div className="font-heading_secondary text-white font-semibold text-xl w-full">
            <p>Follow Us</p>
